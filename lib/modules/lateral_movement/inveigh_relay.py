...
class Module:
    ...
    def generate(self, obfuscate=False, obfuscationCommand=""):
        ...
        if obfuscate:
            moduleSource = self.mainMenu.installPath + "/data/obfuscated_module_source/lateral_movement/Invoke-InveighRelay.ps1"
    ...
    def obfuscate(self, obfuscationCommand="", forceReobfuscation=False):
        ...
        obfuscatedSource = self.mainMenu.installPath + "/data/obfuscated_module_source/lateral_movement/Invoke-InveighRelay.ps1"
