...
class Stager:
    ...
    def generate(self):
        ...
        launcher = self.mainMenu.stagers.generate_launcher(
            listenerName, encode=encode, obfuscate=obfuscateScript, obfuscationCommand=obfuscateCommand, userAgent=userAgent, proxy=proxy, proxyCreds=proxyCreds, stagerRetries=stagerRetries)
